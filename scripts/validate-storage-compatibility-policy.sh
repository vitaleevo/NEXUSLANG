...
require_text "$COMPATIBILITY_PATH" "### Storage Export/Import MVP"
...
require_text "$COMPATIBILITY_PATH" "nexus storage-export path/to/app.nx --storage json --output data.json"
require_text "$COMPATIBILITY_PATH" "nexus storage-import path/to/app.nx --storage sqlite --input data.json --replace"
...
require_text "$GUIDE_PATH" "nexus storage-export path/to/project/inventory.nx --storage json --output data.json"
require_text "$GUIDE_PATH" "nexus storage-import path/to/project/inventory.nx --storage sqlite --input data.json --replace"
